  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950">
      <div className="relative w-12 h-12">
        <div className="piece absolute w-6 h-6 rounded-md bg-gradient-to-br from-violet-500 to-indigo-600" style={{ animationDelay: '0ms', ['--tx' as string]: '-20px', ['--ty' as string]: '-20px', ['--rot' as string]: '-90deg' }}></div>
        <div className="piece absolute w-6 h-6 rounded-md bg-gradient-to-br from-violet-500 to-indigo-600" style={{ animationDelay: '0ms', ['--tx' as string]: '20px', ['--ty' as string]: '-20px', ['--rot' as string]: '90deg' }}></div>
        <div className="piece absolute w-6 h-6 rounded-md bg-gradient-to-br from-violet-500 to-indigo-600" style={{ animationDelay: '0ms', ['--tx' as string]: '-20px', ['--ty' as string]: '20px', ['--rot' as string]: '90deg' }}></div>
        <div className="piece absolute w-6 h-6 rounded-md bg-gradient-to-br from-violet-500 to-indigo-600" style={{ animationDelay: '0ms', ['--tx' as string]: '20px', ['--ty' as string]: '20px', ['--rot' as string]: '-90deg' }}></div>
      </div>
